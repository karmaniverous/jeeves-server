...
export function handleGenericFile(
  ...
  if (query.raw === '1' || !isTextFile) {
    ...
    const headExtra = '<link id="hljs-theme" rel="stylesheet" href="/static/hljs/github-dark.min.css">';
    ...
    const bodyContent = `<pre><code class="hljs${language ? ` language-${language}` : ''}">${highlighted}</code></pre>`;
    ...
    function updateHljsTheme() {
      ...
      link.href = theme === 'dark' 
        ? '/static/hljs/github-dark.min.css'
